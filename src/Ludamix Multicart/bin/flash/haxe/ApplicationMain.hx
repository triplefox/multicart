...
class ApplicationMain {
	...
	public static function main () {
		...
		//nme.Lib.setPackage("nblah", "LudamixMulticart", "com.ludamix.multicart.LudamixMulticart", "1.0.0");
	...
	private static function start ():Void {
		...
		var hasMain = false;
		var mainClass = Type.resolveClass ("com.ludamix.multicart.Main");
...
import com.ludamix.multicart.Main;
...
class ApplicationMain {
	...
	public static function main () {
		...
		for (methodName in Type.getClassFields (com.ludamix.multicart.Main)) {
		...
		if (hasMain) {
			...
			Reflect.callMethod (com.ludamix.multicart.Main, Reflect.field (com.ludamix.multicart.Main, "main"), []);
...
@:keep class DocumentClass extends com.ludamix.multicart.Main { }
